...
pnpm -r run test                                       # 566 tests, all packages
cd contracts && forge test                             # 70 Solidity tests (636 in total)
...
**636 in total**, and the figures above are measured by `scripts/record-suite.sh` into [`/api/suite.json`](https://the-record.vercel.app/api/suite.json)
